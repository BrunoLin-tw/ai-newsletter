    ...
    <div class="container">
        <header class="glass-effect">
            ...
            <nav>
                ...
                <a href="/$PROJECT_NAME/search.html">搜尋文章</a>
            </nav>
        </header>
        <main>
EOF
  ...
  <div class="container">
    <header class="glass-effect">
      ...
      <nav>
        ...
        <a href="/ai-newsletter/search.html">搜尋文章</a>
      </nav>
    </header>
    <main>
...
EOF
    ...
    cat >> "$tmp" << 'INDEXEOF'
      ...
      <div class="archive-link">
        <a href="/ai-newsletter/archive.html" class="btn secondary">查看歷史存檔</a>
      </div>
    </main>
    <footer>
      <p>Generated by OpenClaw Agent | <a href="https://github.com/BrunoLin-tw/ai-newsletter">GitHub Repo</a></p>
  ...
  <div class="container">
    <header class="glass-effect">
      ...
      <nav>
        <a href="/ai-newsletter/">最新</a>
        <a href="/ai-newsletter/archive.html">歷史存檔</a>
        <a href="/ai-newsletter/search.html" class="active">搜尋文章</a>
      </nav>
    </header>
    <main>
      <div class="section-header">
  ...
  <script>
    ...
    function performSearch(query) {
      ...
      if (filtered.length === 0) {
        resultsContainer.innerHTML = '<p>找不到符合的內容</p>';
        return;
      }
